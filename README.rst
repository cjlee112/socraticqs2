...
We have created a rapid prototyping tool for experimenting with Courselets chat interface, which runs entirely in the browser (using Brython).  Assuming your developer environment has the standard web assets (auto-generated by our docker setup), you can test the rapid prototyping tool as follows::

  cd mysite/lms
  python3 -m http.server

Then point your web browser to http://localhost:8000/static/chatproto/faqdemo.html

On the displayed web page, choose your desired demo settings, then click **Start Demo**.
